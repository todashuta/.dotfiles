...
(leaf cus-start
  ...
  ;; (custom-set-faces
  ;;  '(mode-line
  ;;    ((t (:family "UDEV Gothic JPDOC" :foundry "outline" :slant normal :weight bold :height 100 :width normal)))))
  ;; (custom-set-faces
  ;;  '(org-block
  ;;    ((t (:family "UDEV Gothic JPDOC" :foundry "outline" :slant normal :weight normal :height 100 :width normal)))))
  ;; (let* ((common-props
  ;;         '(:family "UDEV Gothic JPDOC" :foundry "outline" :slant normal :height 100 :width normal)))
  ;;   (custom-set-faces
  ;;    `(default
  ;;       ((t ,(plist-put (copy-alist common-props) :weight 'normal)))))
  ;;   (custom-set-faces
  ;;    `(mode-line
  ;;      ((t ,(plist-put (copy-alist common-props) :weight 'bold)))))
  ;;   (custom-set-faces
  ;;    '(org-block
  ;;      ((t ,(plist-put (copy-alist common-props) :weight 'normal))))))
