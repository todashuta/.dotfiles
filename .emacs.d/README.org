...
(leaf org-mode
  :custom ((org-use-speed-commands                 . t)
           ...
           (org-agenda-files       . '("~/org-docs/tasks.org"
                                       "~/org-docs/notes.org"
                                       "~/org-docs/projects/"))
           (org-capture-templates . '(("t" "タスク" entry (file+headline "~/org-docs/tasks.org" "タスク一覧")
                                       "** TODO %?\n  %^T")
                                      ("m" "メモ" entry (file+headline "~/org-docs/notes.org" "メモ帳")
                                       "** %U %?\n  %l")))
           )
