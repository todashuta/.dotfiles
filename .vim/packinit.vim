...
call minpac#add('kana/vim-operator-user',     {'type': 'opt'})
call minpac#add('kana/vim-operator-replace',  {'type': 'opt'})
call minpac#add('kana/vim-textobj-user',      {'type': 'opt'})
call minpac#add('kana/vim-textobj-syntax',    {'type': 'opt'})
...
call minpac#add('osyo-manga/vim-textobj-multiblock', {'type': 'opt'})
